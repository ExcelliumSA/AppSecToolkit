...
function Add-Browsers {
    ...
    Get-RemoteFile -Uri "https://download3.portableapps.com/portableapps/FirefoxPortable/FirefoxPortable_91.0_English.paf.exe?20190321" -OutFile "$WorkFolder\Browsers\firefox-portable.exe" -UseClassicWay
